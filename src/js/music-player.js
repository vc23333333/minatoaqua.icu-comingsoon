...
const dance = document.getElementById('music-player-viewer');
...
function setBarPos(pos) {
	...
	const timeUntilMinatoAqua = MINATOAQUA_VOCALS_POS - seek;
	document.getElementById('time-until-minatoaqua').innerText = Math.max(Math.ceil(timeUntilMinatoAqua), 0);

	if (timeUntilMinatoAqua <= 0) {
